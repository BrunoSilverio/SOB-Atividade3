...
\textsc{\LARGE Pontifícia Universidade Católica Campinas}\\[1.0cm] % Name of your university/college
...
\begin{center} \large
\emph{Supervisor:} \\
Ms. Prof. Edmar Roberto Santana de \textsc{Resende}\\[1cm] % Supervisor's Name
\end{center}
% \end{minipage
...
%	LOGO SECTION
%----------------------------------------------------------------------------------------
\includegraphics[width=26mm]{logo.jpg}\\[1cm]% Include a department/university logo - this will require the graphicx package
{\large \today}\\[1cm]
%----------------------------------------------------------------------------------------
...
\subsection{Módulo cryptomodule}
